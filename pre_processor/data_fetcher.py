...
def fetch_data(conf: Config) -> bool:
	"""This function is responsible to get/pull/download data from a certain location to the machine where the pipeline is running"""
	...
	assert output_file_path_video.exists() and output_file_path_lyrics.exists()
